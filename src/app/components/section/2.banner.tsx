  ...
  return (
    <section className="py-10">
      <div className="container mx-auto px-4">
        <motion.div
          className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl shadow-lg overflow-hidden border border-blue-100 dark:border-blue-800"
          {...variants()}
        >
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              ...
              >
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-300">包含完整教程和实战案例</span>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="bg-gray-50 dark:bg-gray-700 rounded p-3">
                  ...
                  <div className="flex justify-between">
                    <div className="text-center">
                      <div className="bg-gray-200 dark:bg-gray-600 rounded px-2 py-1 font-mono font-bold text-lg">{timeLeft.days}</div>
                      <div className="text-xs mt-1 text-gray-500">天</div>
                    </div>
                    <div className="text-center">
                      <div className="bg-gray-200 dark:bg-gray-600 rounded px-2 py-1 font-mono font-bold text-lg">{timeLeft.hours}</div>
                      <div className="text-xs mt-1 text-gray-500">时</div>
                    </div>
                    <div className="text-center">
                      <div className="bg-gray-200 dark:bg-gray-600 rounded px-2 py-1 font-mono font-bold text-lg">{timeLeft.minutes}</div>
                      <div className="text-xs mt-1 text-gray-500">分</div>
                    </div>
                    <div className="text-center">
                      <div className="bg-gray-200 dark:bg-gray-600 rounded px-2 py-1 font-mono font-bold text-lg">{timeLeft.seconds}</div>
                ...
                <Link
                  href={`/course/${latestCourse.id}/preview`}
