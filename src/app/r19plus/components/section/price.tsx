...
export default function Price() {
  ...
  return (
    <main className='py-14 px-6 md:px-0'>
      <div className="mx-auto max-w-[1080px]">
        ...
        <div
          ...
          {pricing.tiers.map((tier, index) => (
            <motion.div {...variants(tier.delay)} key={tier.id} className={classNames(tier.mostPopular ? 'ring-1 ring-indigo-600' : 'ring-1 ring-gray-200', 'rounded p-8')}>
