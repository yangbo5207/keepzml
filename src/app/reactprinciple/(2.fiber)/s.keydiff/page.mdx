...
![](https://files.mdnice.com/user/3925/69e8e0a2-4995-416f-a176-093b38aafc86.png)
...
![](https://files.mdnice.com/user/3925/336d4a28-349d-4935-9dc3-0e17d5f393b4.png)
...
![](https://files.mdnice.com/user/3925/09257d76-2e03-4919-845f-41ead26e23df.png)
...
![](https://files.mdnice.com/user/3925/7dfaeebf-edb3-4d08-b8cf-eec06633548f.png)

当我新增一个项时，仔细观察两个列表的差异。

![](https://files.mdnice.com/user/3925/a61a4cbf-9763-4265-b924-5fd619bc9b1c.gif)
...
+ 没找到匹配的 key，则创建新节点
+ 找到了匹配的key，则通过如下的方式判断，来移动节点，移动节点指的是 DOM 节点的移动操作，从旧列表中的索引位置，移动到新列表的索引位置中来
...
双端比较会使用 4 个指针，分别记录旧列表和新列表的首位两个节点位置。
...
比较的规则遵循：**首-首**比较，**尾-尾**比较，**尾-首**比较，**首-尾**比较的顺序。通过这样方式找出首位是否有节点可以被复用。
...
在首次经过四次比较之后，发现 **新首-旧尾** key 值相同，可以复用，此时需要通过移动首位索引指针构建新的新旧节点数组
